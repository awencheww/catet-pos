...
<html lang="en" data-bs-theme="auto">
  <head><script src="{{ asset('assets/custom/js/color-modes.js') }}"></script>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="">
    <meta name="author" content="Cherwen Molina">
    <meta name="generator" content="Hugo 0.118.2">
    <title>Register · Catet's Sweets & Cakes</title>
    
<link href="{{ asset('assets/bootstrap-5.3.2/css/bootstrap.min.css') }}" rel="stylesheet">
<link rel="icon" href="{{ asset('assets/icon/fav-icon.ico') }}" type="image/x-icon">
...
<main class="form-register w-100 m-auto text-center">
  ...
  <form>
    ...
    <h1 class="h3 mb-3 fw-normal">Fill Out All Fields</h1>
    ...
    <div class="form-floating mb-2">
      <input type="text" class="form-control" name="address" id="address" placeholder="Purok 1B, Brgy. Sabang, Sample City, SDN">
    ...
    <a href="/"><button class="btn btn-secondary w-100 py-2" type="button">Cancel</button></a>
